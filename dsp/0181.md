...
export interface IPortableExperiencesController {
   ...
   * @param  {PortableExperienceHandle} [handler] - The handle that has the context of the running PE
   *
   * Returns true if was able to kill the portable experience, false if not.
   */
  kill(executor: Executor, handler: PortableExperienceHandle): Promise<boolean>
